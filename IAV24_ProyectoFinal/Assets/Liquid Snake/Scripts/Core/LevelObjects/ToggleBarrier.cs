...
namespace LiquidSnake.LevelObjects
{
    public class ToggleBarrier : MonoBehaviour, IResetteable
    {
        ...
        private NavMeshObstacle _laserNavMeshObstacle;
        ...
        private void Awake()
        {
            ...
            _laserNavMeshObstacle = GetComponent<NavMeshObstacle>();
        }
        ...
        IEnumerator ToggleLaserCoroutine()
        {
            ...
            _laserNavMeshObstacle.enabled = _shouldBeEnabled;
        ...
        public void Reset()
        {
            ...
            _laserNavMeshObstacle.enabled = originallyEnabled;
