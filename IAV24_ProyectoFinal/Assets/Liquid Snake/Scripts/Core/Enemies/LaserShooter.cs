...
namespace LiquidSnake.Enemies
{
    ...
    public class LaserShooter : MonoBehaviour, IResetteable
    {
        ...
        /// <summary>
        /// Número de balas actuales
        /// </summary>
        [SerializeField]
        public int numAmmos = 20;

        /// <summary>
        /// Sensor
        /// </summary>
        [SerializeField]
        private GameObject visionSensor = null;

        /// <summary>
        /// Para desactivar la detección al jugador tras gastar las balas
        /// </summary>
        ...
        {
            if (shootPoint == null || _timeUntilNextShoot > 0f || numAmmos<=0)
            {
                if (numAmmos <= 0) { 
                    visionSensor.SetActive(false);
